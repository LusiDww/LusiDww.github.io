      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?= $member['Username']; ?></span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?= base_url('dashboard_member/myprofile'); ?>">
  ...
  <aside id="sidebar" class="sidebar bg-primary">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <a class="card-title text-white">
        <span class="text-white">Selamat datang, Member!</span>

        <hr class="sidebar-divider bg-light">
        <li class="nav-item">
          <a class="nav-link bg-primary" href="<?php echo base_url('Dashboard') ?>">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed bg-primary" href="<?php echo base_url('buku') ?>">
        ...
        <li class="nav-item">
          ...
          <ul id="components-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
            <li>
              <a href="<?php echo base_url() . 'buku/tampil'; ?>">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed bg-primary" href="<?= base_url('auth/logout'); ?>">
